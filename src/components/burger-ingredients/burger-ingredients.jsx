...
function BurgerIngredients() {
    ...
    console.log("DDD, state: "+ JSON.stringify(state));
    ...
    return(
        ...
        <>
            ...
            {console.log("BBB, selectedIngredient: "+JSON.stringify(selectedIngredient))}
            ...
            {
                selectedIngredient.name !== undefined && /*console.log("DDD, state: "+ JSON.stringify(state)) &&*/(
                    <Modal
