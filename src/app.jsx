...
function App() {
  ...
  console.log("AAA, background: "+JSON.stringify(background))

  //console.log("AAA, background: "+background)

  //console.log("AAA, location.state: "+location.state)
  //console.log("AAA, location.state.background: "+location.state.background)
  ...
  return (
    <>
      ...
      <Routes location={background || location}>
        ...
        {console.log("EEE, state: "+JSON.stringify(state))}
        {console.log("FFF, background: "+JSON.stringify(background))}
        {background &&  (
            <Route
                path={INGRIDIENTS_ID}
                element={
